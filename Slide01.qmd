...
- 実習ではRをサポート
    ...
    - Main Package: [mlr3verse](https://mlr3verse.mlr-org.com/), [mlr3pipelines](https://github.com/mlr-org/mlr3pipelines), [DoubleML](), [grf](https://grf-labs.github.io/grf/)
...
- OLS推定: $E_P[Y|X],E_P[D|X]$ を同じ線形モデルで回帰
...
- AIPW推定, Conditional Average Treatment Effect推定 [@semenova2021debiased; @Kallus2022TreatmentER; @wager2018estimation] , Mediation Analysis [@farbmacher2022causal; @diaz2021nonparametric] , Sensitivity Analysis [@chernozhukov2022long] などなど
